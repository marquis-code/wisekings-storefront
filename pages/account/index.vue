<template>
  <div class="space-y-12">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
      <div class="space-y-2">
        ...
        <div class="flex items-center gap-3">
          ...
          <p class="text-xs font-bold text-[#033958]/80">Join 2.4k+ Royal Members snacking smarter.</p>
        </div>
      </div>
      <div class="flex items-center gap-4">
        <div class="px-6 py-3 bg-white border border-gray-100 rounded-2xl  flex items-center gap-3 group hover:border-[#033958]/20 transition-all cursor-default">
          ...
          <div>
            <p class="text-sm font-black uppercase tracking-widest text-[#033958]/80">Tier Status</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div class="p-8 bg-gradient-to-br from-[#033958] to-[#022c45] rounded-[40px]  /30 relative overflow-hidden group">
        ...
        <div class="relative z-10 space-y-8">
          <div class="flex items-center justify-between">
            ...
            <span class="px-3 py-1 bg-amber-400/20 text-amber-100 rounded-full text-sm font-black uppercase tracking-widest border border-amber-400/20">+12% this week</span>
          </div>
          <div>
            <h2 class="font-black text-white/40 text-xs uppercase tracking-[0.3em]">Available Loyalty</h2>
          ...
          <button class="w-full py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl text-xs font-black uppercase tracking-widest text-white transition-all">
            Redeem Rewards
          </button>
        </div>
      </div>
      ...
      <!-- Active Orders Card -->
      <div class="p-8 bg-white border border-gray-100 rounded-[40px]  hover: hover:shadow-gray-200/50 transition-all flex flex-col justify-between group relative overflow-hidden">
        ...
        <div class="relative z-10">
          ...
          <h2 class="font-black text-[#033958]/80 text-xs uppercase tracking-[0.3em]">Shipments Pending</h2>
          <p class="text-5xl font-black text-gray-900 mt-3 tracking-tighter">{{ orders.length.toString().padStart(2, '0') }}</p>
        </div>
        <NuxtLink to="/account/orders" class="relative z-10 text-xs font-black uppercase tracking-widest text-[#033958] flex items-center gap-2 mt-10 group-hover:gap-3 transition-all border-t border-gray-50 pt-6">
      ...
      <div class="p-8 bg-white border border-gray-100 rounded-[40px]  hover: hover:shadow-gray-200/50 transition-all flex flex-col justify-between group relative overflow-hidden">
        ...
        <div class="relative z-10">
          ...
          <h2 class="font-black text-[#033958]/80 text-xs uppercase tracking-[0.3em]">Saved Destinations</h2>
          <p class="text-5xl font-black text-gray-900 mt-3 tracking-tighter">01</p>
        </div>
        <NuxtLink to="/account/profile" class="relative z-10 text-xs font-black uppercase tracking-widest text-amber-600 flex items-center gap-2 mt-10 group-hover:gap-3 transition-all border-t border-gray-50 pt-6">
          Manage Preferences
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
      ...
      <div class="lg:col-span-8 space-y-6">
        <div class="flex items-center justify-between px-2">
          <div class="flex items-center gap-3">
            ...
            <h3 class="text-sm font-black uppercase tracking-[0.25em] text-[#033958]/80">Transaction Pulse</h3>
          </div>
          <NuxtLink to="/account/orders" class="text-xs font-black uppercase tracking-widest text-[#033958] hover:gap-2 transition-all flex items-center gap-1 group">
            History
        ...
        <div class="bg-gray-50/50 rounded-[40px] border border-gray-100 overflow-hidden">
          ...
          <div v-else-if="orders.length === 0" class="p-20 text-center space-y-4">
            <div class="w-20 h-20 bg-white rounded-3xl  shadow-gray-200 font-black flex items-center justify-center mx-auto text-gray-100 group">
            ...
            <div class="space-y-1">
              ...
              <p class="text-xs font-bold text-[#033958]/80 uppercase tracking-widest">Your snacking history is currently blank.</p>
            </div>
          </div>
          <div v-else class="divide-y divide-gray-100">
            ...
            >
              <div class="flex items-center gap-6">
                <div class="w-14 h-14 rounded-2xl bg-white border border-gray-100 flex items-center justify-center  group-hover: transition-all">
                ...
                <div>
                  <p class="text-xs font-black text-[#033958]/80 uppercase tracking-[0.2em] mb-1 leading-none">{{ order.orderNumber }}</p>
              ...
              <div class="text-right">
                ...
                <p class="text-sm font-bold text-[#033958]/80 uppercase tracking-widest mt-1">{{ new Date(order.createdAt).toLocaleDateString() }}</p>
              </div>
            </NuxtLink>
          </div>
        </div>
      ...
      <div class="lg:col-span-4 space-y-8">
        <h3 class="text-sm font-black uppercase tracking-[0.25em] text-[#033958]/80 px-2">Ecosystem</h3>
        <div class="space-y-4">
          <div class="p-6 bg-white border border-gray-100 rounded-3xl  space-y-4 hover:border-[#033958]/20 transition-all group">
            ...
            <p class="text-xs font-medium text-[#033958]/80">Give ₦500, Get ₦500 in loyal points for every snack partner you bring.</p>
            <button class="text-sm font-black uppercase tracking-[0.2em] text-[#033958] py-2 border-b border-[#033958]/10 w-fit group-hover:border-[#033958] transition-all">Copy Invite Link</button>
          </div>
          ...
          <div class="p-6 bg-[#033958]/5 border border-[#033958]/10 rounded-3xl flex items-center gap-4 group cursor-pointer hover:bg-[#033958]/10 transition-all">
            ...
            <div>
              <p class="text-xs font-black uppercase tracking-widest text-[#033958]">Concierge</p>
              <p class="text-sm font-bold text-[#033958]/80 uppercase tracking-[0.1em]">24/7 Support Desk</p>
            </div>
          </div>
        </div>
      </div>
