      ...
      <div class="absolute inset-y-0 right-0 max-w-full flex">
        <div class="relative w-screen max-w-md bg-white  flex flex-col">
          ...
          <div v-if="items.length > 0" class="px-6 py-8 border-t border-gray-100 bg-gray-50/50 space-y-6">
            ...
            <button @click="handleCheckout" class="w-full bg-[#033958] text-white py-4 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-gray-950 transition-all shadow-lg shadow-[#033958]/20 flex items-center justify-center gap-4 group">
              Checkout Now
