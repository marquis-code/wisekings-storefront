...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrRenderList, ssrRenderSlot, ssrInterpolate } from "vue/server-renderer";
import { _ as _imports_0 } from "./hero5-D2ejfIpG.js";
import { _ as _imports_0$1 } from "./logo-3eGD44Sm.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div><div class="absolute bottom-8 left-0 right-0 text-center px-6"><p class="text-sm text-gray-400"> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} WiseKings. All rights reserved. </p></div></div></div>`);
}
...
//# sourceMappingURL=auth-CJiRY_Nc.js.map
