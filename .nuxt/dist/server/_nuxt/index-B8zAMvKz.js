...
import { defineComponent, ref, withCtx, createTextVNode, toDisplayString, createVNode, unref, openBlock, createBlock, createCommentVNode, useSSRContext } from "vue";
...
import { u as useFetchProducts, a as useFetchCategories } from "./useFetchCategories-kKybYx7z.js";
import "./axios.config-BkQMnnZW.js";
import { _ as _imports_0$1 } from "./hero1-jqtTISVW.js";
import { _ as _imports_0$2 } from "./hero2-BLjoqdhM.js";
import { _ as _imports_0$3 } from "./hero5-D2ejfIpG.js";
...
const _imports_0 = "" + __buildAssetsURL("holiday.BcoQ3Wm-.jpg");
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`</div><h3 class="text-sm font-bold text-gray-900 group-hover:text-[#033958] transition-colors line-clamp-1"${_scopeId}>${ssrInterpolate(p.name)}</h3><div class="flex items-center gap-2 mt-1"${_scopeId}><span class="text-sm font-extrabold text-gray-900"${_scopeId}>₦${ssrInterpolate(p.price?.toLocaleString())}</span>`);
              if (p.compareAtPrice) {
              ...
              return [
                ...
                createVNode("div", { class: "flex items-center gap-2 mt-1" }, [
                  createVNode("span", { class: "text-sm font-extrabold text-gray-900" }, "₦" + toDisplayString(p.price?.toLocaleString()), 1),
...
//# sourceMappingURL=index-B8zAMvKz.js.map
