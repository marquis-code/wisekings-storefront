...
const _routes = [
  ...
  },
  {
    name: "cart",
    path: "/cart",
    component: () => import("./_nuxt/cart-DeyY4vsj.js")
  },
  {
    name: "about",
    path: "/about",
  ...
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import("./_nuxt/index-BWnRMeDz.js")
  },
  {
    name: "products",
    path: "/products",
...
const layouts = {
  ...
  default: defineAsyncComponent(() => import("./_nuxt/default-lQnQrnDP.js").then((m) => m.default || m))
};
