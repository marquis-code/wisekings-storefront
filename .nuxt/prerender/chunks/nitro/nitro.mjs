import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, getCookie, setCookie, sanitizeStatusCode, removeResponseHeader, createError, getQuery as getQuery$1, getRouterParam, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/h3/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL, parsePath, withLeadingSlash, decodePath, withoutTrailingSlash } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/destr/dist/index.mjs';
...
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/unstorage/dist/index.mjs';
...
import fsDriver from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/unstorage/drivers/lru-cache.mjs';
...
import defu, { defuFn, createDefu } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/defu/dist/defu.mjs';
...
import { createRouterMatcher } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue-router/vue-router.node.mjs';
...
const _47Users_47mac_47Documents_47wisekings_47storefront_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage$1.mount('internal:nuxt:prerender', _47Users_47mac_47Documents_47wisekings_47storefront_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/Users/mac/Documents/wisekings/storefront/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/Users/mac/Documents/wisekings/storefront/.nuxt/cache/nitro/prerender"}));
storage$1.mount('data', fsDriver({"driver":"fsLite","base":"./.data/kv"}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mac/Documents/wisekings/storefront","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mac/Documents/wisekings/storefront/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mac/Documents/wisekings/storefront/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mac/Documents/wisekings/storefront/.nuxt/cache"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "12bbfcee-f6aa-44ae-924f-d1c7f7c0d859",
  ...
  "public": {
    ...
    "firebaseStorageBucket": "wisekings-fe40a.firebasestorage.app",
    "firebaseMessagingSenderId": "360424943021",
    "firebaseAppId": "1:360424943021:web:9880c08d3bea139ea00524",
    "firebaseMeasurementId": "G-P6N7ECWN6B",
    "i18n": {
      "baseUrl": "",
      "defaultLocale": "en",
      "rootRedirect": "",
...
var welcome$2 = "Welcome to WiseKings";
var premium_products$2 = "Shop premium products at WiseKings. Quality guaranteed.";
...
var premium_products = "Compre productos premium en WiseKings. Calidad garantizada.";
...
const _mHd4hMNgU8RTbMvuEo_Fbn8_O5jnH9iV40lo5T7T5kY = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async (context) => {
    ...
    if (!url.pathname.includes("/_i18n/zysqTIjm") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const plugins = [
  _mHd4hMNgU8RTbMvuEo_Fbn8_O5jnH9iV40lo5T7T5kY
];
...
const _SyELUS = _messagesHandlerCached;

const _lazy_W2WR_C = () => import('../_/renderer.mjs').then(function (n) { return n.r; });
...
const handlers = [
  ...
  { route: '/_i18n/:hash/:locale/messages.json', handler: _SyELUS, lazy: false, middleware: false, method: undefined },
