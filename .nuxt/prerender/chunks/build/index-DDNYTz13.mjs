...
import { defineComponent, mergeProps, unref, withCtx, createTextVNode, createVNode, toDisplayString, useSSRContext } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrRenderComponent, ssrInterpolate } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/server-renderer/index.mjs';
import { a as useAuthState } from './server.mjs';
import { u as useFetchOrders } from './useFetchOrders-f7F6HpNi.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(3, (i) => {
        var _a2;
        _push(`<div class="w-6 h-6 rounded-full border-2 border-white bg-gray-100 flex items-center justify-center overflow-hidden"><img${ssrRenderAttr("src", `https://api.dicebear.com/7.x/avataaars/svg?seed=${(_a2 = unref(user)) == null ? void 0 : _a2.fullName}${i}`)} class="w-full h-full object-cover"></div>`);
      });
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              ...
              if (_push2) {
                ...
                _push2(`</div><div${_scopeId}><p class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-1 leading-none"${_scopeId}>${ssrInterpolate(order.orderNumber)}</p><p class="text-sm font-black text-gray-900"${_scopeId}>${ssrInterpolate((_a2 = order.items) == null ? void 0 : _a2.length)} Snacking Items</p></div></div><div class="text-right"${_scopeId}><p class="text-sm font-black text-gray-900"${_scopeId}>\u20A6${ssrInterpolate(order.totalAmount.toLocaleString())}</p><p class="text-[9px] font-bold text-gray-400 uppercase tracking-widest mt-1"${_scopeId}>${ssrInterpolate(new Date(order.createdAt).toLocaleDateString())}</p></div>`);
              } else {
                return [
                  createVNode("div", { class: "flex items-center gap-6" }, [
                    ...
                    createVNode("div", null, [
                      ...
                      createVNode("p", { class: "text-sm font-black text-gray-900" }, toDisplayString((_b = order.items) == null ? void 0 : _b.length) + " Snacking Items", 1)
                    ])
                  ]),
...
//# sourceMappingURL=index-DDNYTz13.mjs.map
