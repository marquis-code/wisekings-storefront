import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import * as Vue from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/index.mjs';
import { readonly, hasInjectionContext, inject, toRef, isRef, ref, computed, getCurrentInstance as getCurrentInstance$1, shallowRef, defineAsyncComponent, defineComponent, createElementBlock, provide, cloneVNode, h, unref, shallowReactive, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, watch, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, nextTick, mergeProps, getCurrentScope, isReadonly, isShallow, isReactive, toRaw } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL, appendHeader } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue-router/vue-router.node.mjs';
import { defuFn, createDefu, defu } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery, parsePath, parseQuery, withoutTrailingSlash } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/ufo/dist/index.mjs';
import { klona } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/klona/dist/index.mjs';
import { parse as parse$1 } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
import destr from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/destr/dist/index.mjs';
import { isEqual } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/ohash/dist/index.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./otp-BIC8iFrc.mjs')
  },
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-D1jkLqnP.mjs')
  },
  {
    name: "about",
    path: "/about",
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DQyexzXp.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$6 || {},
    component: () => import('./login-A-jdQkma.mjs')
  },
  {
    name: "terms",
    path: "/terms",
  ...
  },
  {
    name: "offers",
    path: "/offers",
    component: () => import('./offers-BOxYXeQH.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DxVJdmNK.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
  ...
  },
  {
    ...
    component: () => import('./register-DGMQm_Z3.mjs')
  },
  {
    name: "categories",
    path: "/categories",
    component: () => import('./categories-BGqs3sVe.mjs')
  },
  {
    name: "account",
    path: "/account",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./index-BGcZf_sW.mjs')
  },
  {
    name: "return-policy",
    path: "/return-policy",
  ...
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./index-BUyZwmIM.mjs')
  },
  {
    name: "products",
    path: "/products",
    component: () => import('./index-CBgO9WWB.mjs')
  },
  {
    name: "account-profile",
    path: "/account/profile",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./profile-KTSfYYyU.mjs')
  },
  {
  ...
  },
  {
    name: "products-slug",
    path: "/products/:slug()",
    component: () => import('./_slug_-Ik6poVwQ.mjs')
  },
  {
  ...
  },
  {
    ...
    component: () => import('./success-DgtV77Ak.mjs')
  },
  {
    name: "account-orders-id",
    path: "/account/orders/:id()",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./_id_-BYi4TmM1.mjs')
  },
  {
    name: "account-orders",
    path: "/account/orders",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-Eo2bYRhj.mjs')
  }
];
...
const layouts = {
  account: defineAsyncComponent(() => import('./account-CwlcP4Oc.mjs').then((m) => m.default || m)),
  auth: defineAsyncComponent(() => import('./auth-BTML3Qrb.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CIyofD8R.mjs').then((m) => m.default || m))
};
