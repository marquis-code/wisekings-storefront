...
import { defineComponent, ref, computed, mergeProps, unref, withCtx, createVNode, createTextVNode, useSSRContext } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrIncludeBooleanAttr, ssrRenderComponent } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/server-renderer/index.mjs';
import { _ as _imports_0 } from './logo-3eGD44Sm.mjs';
import { useRoute, useRouter } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue-router/vue-router.node.mjs';
...
const useVerifyOtp = () => {
  ...
  const verifyOtp = async (payload) => {
    ...
    try {
      ...
      const d = (res == null ? void 0 : res.data) || res;
      if ((d == null ? void 0 : d.user) && ((d == null ? void 0 : d.accessToken) || (d == null ? void 0 : d.tokens))) {
...
//# sourceMappingURL=otp-DlYuWy8V.mjs.map
