...
import { defineComponent, mergeProps, withCtx, createVNode, unref, ref, useSSRContext } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrRenderAttr } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/server-renderer/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(order).items, (item) => {
          ...
          _push(`</div><div><p class="text-sm font-black text-gray-900">${ssrInterpolate(item.name)}</p><p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-1">\u20A6${ssrInterpolate(item.price.toLocaleString())} \xB7 Qty: ${ssrInterpolate(item.quantity)}</p></div></div><p class="text-sm font-black text-gray-900">\u20A6${ssrInterpolate((item.price * item.quantity).toLocaleString())}</p></div>`);
        });
...
//# sourceMappingURL=_id_-Bjvbw2vx.mjs.map
