...
import { defineComponent, ref, computed, watch, mergeProps, unref, withCtx, createTextVNode, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString, useSSRContext } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrInterpolate } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/server-renderer/index.mjs';
import { p as products_api } from './products-CedEkygp.mjs';
import { u as useCustomToast } from './useCustomToast-CwIASTqq.mjs';
import { d as useRoute, b as useAnalytics, u as useHead, e as useNuxtApp } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    watch(product, (newVal) => {
      if (newVal == null ? void 0 : newVal._id) {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              ...
              if (_push2) {
                ...
                if ((_a2 = p.images) == null ? void 0 : _a2[0]) {
                ...
                return [
                  createVNode("div", { class: "aspect-square bg-gray-50 rounded-3xl overflow-hidden mb-3 border border-gray-100 group-hover:shadow-lg transition-all duration-300" }, [
                    ((_b2 = p.images) == null ? void 0 : _b2[0]) ? (openBlock(), createBlock("img", {
                      key: 0,
                      src: p.images[0],
                      alt: p.name,
...
//# sourceMappingURL=_slug_-D1wSA2Tv.mjs.map
