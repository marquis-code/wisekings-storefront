...
import { defineComponent, ref, withAsyncContext, withCtx, createTextVNode, unref, useSSRContext } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/index.mjs';
...
import { useRouter } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue-router/vue-router.node.mjs';
...
const useLogin = () => {
  ...
  const login = async (payload) => {
    ...
    try {
      ...
      if (data == null ? void 0 : data.mfaRequired) {
        showToast({
          title: "OTP Required",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { signInWithPopup } = ([__temp, __restore] = withAsyncContext(() => import('file:///Users/mac/Documents/wisekings/storefront/node_modules/firebase/auth/dist/index.mjs')), __temp = await __temp, __restore(), __temp);
...
//# sourceMappingURL=login-ChBucRuq.mjs.map
