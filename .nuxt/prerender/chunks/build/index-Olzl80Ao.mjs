...
import { defineComponent, mergeProps, unref, withCtx, createTextVNode, createVNode, openBlock, createBlock, toDisplayString, useSSRContext } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderClass } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/server-renderer/index.mjs';
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              ...
              if (_push2) {
                ...
                if ((_b = (_a = o.items) == null ? void 0 : _a[0]) == null ? void 0 : _b.image) {
                ...
                return [
                  createVNode("div", { class: "flex items-center gap-6" }, [
                    createVNode("div", { class: "w-16 h-16 rounded-[24px] bg-gray-50 border border-gray-100 flex items-center justify-center group-hover:bg-[#033958] transition-all duration-500 overflow-hidden shrink-0" }, [
                      ((_e = (_d = o.items) == null ? void 0 : _d[0]) == null ? void 0 : _e.image) ? (openBlock(), createBlock("img", {
                        key: 0,
                        src: o.items[0].image,
                    ...
                    createVNode("div", { class: "space-y-1" }, [
                      ...
                      createVNode("p", { class: "text-sm font-black text-gray-900" }, toDisplayString(((_f = o.items) == null ? void 0 : _f.length) || 0) + " items \xB7 Ready for dispatch", 1),
...
//# sourceMappingURL=index-Olzl80Ao.mjs.map
