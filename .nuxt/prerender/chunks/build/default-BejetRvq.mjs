...
import { defineComponent, ref, watch, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, useSSRContext, computed, nextTick } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderSlot } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/vue/server-renderer/index.mjs';
import { a as useAuthState, d as useRoute, p as useI18n, h as useRuntimeConfig } from './server.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { io } from 'file:///Users/mac/Documents/wisekings/storefront/node_modules/socket.io-client/build/esm-debug/index.js';
import { _ as _imports_0 } from './logo-3eGD44Sm.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const currentCurrencySymbol = computed(() => {
      var _a;
      return ((_a = currencies.find((c) => c.code === selectedCurrency.value)) == null ? void 0 : _a.symbol) || "";
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_1;
...
const useChat = () => {
  ...
  const joinRoom = (conversationId) => {
    var _a;
    (_a = socket.value) == null ? void 0 : _a.emit("chat:join", conversationId);
  };
  ...
  const sendTyping = (conversationId, typing) => {
    var _a;
    (_a = socket.value) == null ? void 0 : _a.emit("chat:typing", { conversationId, isTyping: typing });
  };
  const disconnect = () => {
    var _a;
    (_a = socket.value) == null ? void 0 : _a.disconnect();
    socket.value = null;
  };
  return {
    messages,
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const currentUserId = computed(() => {
      var _a;
      return ((_a = user.value) == null ? void 0 : _a._id) || "guest";
    });
    const isOpen = ref(false);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</a></div></div></div><div class="pt-10 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6"><p class="text-gray-400 text-xs font-bold">\xA9 ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} WiseKings. Engineered for Royals.</p></div></div></footer>`);
...
//# sourceMappingURL=default-BejetRvq.mjs.map
